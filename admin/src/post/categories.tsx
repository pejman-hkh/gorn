...
export function MainForm({ ...props }) {
    ...
    return <Grid.Wrapper key={edit?.id} {...props}>
        ...
        <Grid.Col6>
            <SelectSearch title={t("Parent Category")} default={true} path={"/admin/post/categories?type_id="+(selected?.value||"")} name="category_id" edit={edit} defaultValue={edit?.category_id}>
...
export function Index() {
    ...
    const ModuleBreadcrumb = <BreadCrumb.Item to="/dashboard">{t("Post")}</BreadCrumb.Item>
