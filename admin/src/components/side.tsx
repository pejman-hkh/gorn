...
function MenuText({ children, ...props }:any) {
    return <span {...props} className="ml-3" sidebar-toggle-item>{children}</span>
}
...
function MenuButtonText({ children }: any) {
    return <span className="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>{children}</span>
}
