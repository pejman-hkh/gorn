...
export function SearchForm({ children, ...props }) {
    ...
    return <form onSubmit={handler} className="lg:pr-3" action="" method="GET">
...
export function Tasks({ children, ...props }) {
    return <div className="flex pl-0 mt-3 space-x-1 sm:pl-2 sm:mt-0">
        <a href="#" data-modal-toggle="search-modal" className="inline-flex justify-center p-1 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
...
export function ExportButton({ children, ...props }) {
    return <a href="#" className="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">
...
export function AddButton({ children, ...props }) {
    return <button type="button" data-modal-target="add-user-modal" data-modal-toggle="add-user-modal" className="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
...
export function RightSide({ children, ...props }) {
    return <div className="flex items-center ml-auto space-x-2 sm:space-x-3">
        {children}
    </div>
}
export function LeftSide({ children, ...props }) {
    return <div className="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">{children}</div>
}
