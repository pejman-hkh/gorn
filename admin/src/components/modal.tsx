export function Delete({ children, ...props }: any) {
    return <><div modal-backdrop="1" className="hidden bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-40"></div>
        <div data-modal="" ref={props?.pref} className="hidden fixed left-0 right-0 z-50 items-center justify-center overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full flex" id="delete-modal">
