...
export default function Pagination({...props}) {
    ...
    return <div className="sticky bottom-0 right-0 items-center w-full p-4 bg-white border-t border-gray-200 sm:flex sm:justify-between dark:bg-gray-800 dark:border-gray-700">
        <div className="flex items-center mb-4 sm:mb-0">
            ...
            <span className="text-sm font-normal text-gray-500 dark:text-gray-400">Showing <span className="font-semibold text-gray-900 dark:text-white">1-{props?.pagination?.Size}</span> of <span className="font-semibold text-gray-900 dark:text-white">{props?.pagination?.Count}</span></span>
        </div>
