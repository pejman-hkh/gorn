...
export default function Pagination({ ...props }) {
    ...
    return <div className="sticky bottom-0 right-0 items-center w-full p-4 bg-white border-t border-gray-200 sm:flex sm:justify-between dark:bg-gray-800 dark:border-gray-700">
        <div className="flex items-center mb-4 sm:mb-0">
            ...
            <Link to={props?.module + "?page=" + props?.pagination?.Next} className="inline-flex justify-center p-1 ltr:mr-2 rtl:ml-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
            ...
            <span className="text-sm font-normal text-gray-500 dark:text-gray-400">{t("Showing")} <span className="font-semibold text-gray-900 dark:text-white">1-{props?.pagination?.Size}</span> {t("of")} <span className="font-semibold text-gray-900 dark:text-white">{props?.pagination?.Count}</span></span>
        </div>
        <div className="flex items-center space-x-3">
            <Link to={props?.module + "?page=" + props?.pagination?.Prev} className="rtl:ml-2 inline-flex items-center justify-center flex-1 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                <svg className="rtl:hidden w-5 h-5 ltr:mr-1 rtl:ml-1 -ml-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clipRule="evenodd" /></svg>
            ...
            <Link to={props?.module + "?page=" + props?.pagination?.Next} className="rtl:ml-2 inline-flex items-center justify-center flex-1 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                ...
                <svg className="ltr:hidden w-5 h-5 ltr:mr-1 rtl:ml-1 -ml-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clipRule="evenodd" /></svg>
            </Link>
        </div>
    </div>
}