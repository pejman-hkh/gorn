...
export function Item({ children, ...props }) {
    return <li>
        <div className="flex items-center">
            ...
            <Link to={props.to} className="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">{children}</Link>
...
export function Title({ children, ...props }) {
    return <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">{children}</h1>
}

export function Wrapper({ children, ...props }) {
    return <div className="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
...
export function Main({ children, ...props }) {
    return <div className="mb-4"><nav className="flex mb-5" aria-label="Breadcrumb">
