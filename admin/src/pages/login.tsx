        ...
        <Card title={t("Login")}>
            ...
            <Form action="/login">
                ...
                <div className="flex items-start">
                    ...
                    <Link to="/forget" className="ltr:ml-auto rtl:mr-auto text-sm text-primary-700 hover:underline dark:text-primary-500">{t("Lost Password?")}</Link>
                </div>
                <Button type="submit">{t("Login to your account")}</Button>
