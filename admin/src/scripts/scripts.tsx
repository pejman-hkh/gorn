export default function MainScript() {
    document.querySelectorAll("[data-dropdown-toggle]").on('click.toggle',function (e) {
    ...
    document.querySelectorAll("[data-modal-target],[data-modal-toggle]").on('click.modal', function (e) {
